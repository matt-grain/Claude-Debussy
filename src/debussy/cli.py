...
from debussy.core.models import CompletionSignal, PhaseStatus, RunState, RunStatus
...
def status(
    ...
    if issues:
        asyncio.run(_display_issue_status(run_state, state, refresh, output_format))
